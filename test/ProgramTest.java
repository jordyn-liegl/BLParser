...
public abstract class ProgramTest {
    ...
    @Test(expected = RuntimeException.class)
    public final void testParseErrorExampleDiffProgramIdentifiers() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
    ...
    @Test(expected = RuntimeException.class)
    public final void testParseErrorExampleDiffInstructionIdenitifiers() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
    ...
    @Test(expected = RuntimeException.class)
    public final void testParseErrorExampleTwoSameInstructionIdentifiers() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
